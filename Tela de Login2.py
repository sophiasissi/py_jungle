...
entry1 = customtkinter.CTkEntry(master=frame, placeholder_text="Nome de usuário", width=300, font=("Roboto", 14)).place(x=25, y=105)
...
entry2 = customtkinter.CTkEntry(master=frame, placeholder_text="Senha do usuário", width=300, font=("Roboto", 14)).place(x=25, y=175)
